...
def main(args):
    ...
    while(True):
        ...
        for t in online_targets:
            ...
            if tid not in class_ids:
                # Assign a class ID if this is a new track
                class_ids[tid] = int(labels[scores.argmax()].item())  # Just an example, you might want to improve this
            ...
            class_name = CLASS_MAPPING.get(class_ids[tid], "Unknown")
