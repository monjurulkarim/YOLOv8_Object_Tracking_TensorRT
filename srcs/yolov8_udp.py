...
def xy2latlon(point):
    #homography_matrix
    homography_matrix_obtained =  [[-5.179012660893269, 55.151307185588124, 6983.035245667728304],[10.366907722755846, -6.125985388589109, -1241.986418877135293],[0.089249220866786, 0.042988199877047, 1.000000000000000]]
...
def main(args):
    ...
    while(True):
        ...
        for t in online_targets:
            ...
            center = xy2latlon(calculate_center_point(bbox))
            ...
            frame_data.append({
                ...
                "TrackID": int(tid),
                "Timestamp": current_time #math.round(current_time, 3)
            })
